...
def generate_reply(email_content):
    try:
        ...
        # Adjusted to properly access the message content
...
def create_draft(creds, to_email, subject, body_text):
    ...
    try:
        ...
        print(f"Draft created for {to_email}: {created_draft['id']}")
    except Exception as e:
...
def auto_reply_to_last_two_unread_emails(creds):
    ...
    try:
        ...
        for msg in new_emails:
            ...
            email_from, email_subject, email_body = extract_email_details(msg_data)
            ...
            # Create draft
            create_draft(creds, email_from, f"Re: {email_subject}", reply_content)
